...
class weibo:
    cookie = {"Cookie": "YF-Ugrow-G0=ad06784f6deda07eea88e095402e4243; login_sid_t=ddaa6a889b7c5e23c8f37c29714c4a6f; YF-V5-G0=8a3c37d39afd53b5f9eb3c8fb1874eec; WBStorage=02e13baf68409715|undefined; _s_tentry=-; Apache=4728788087904.334.1496370242002; SINAGLOBAL=4728788087904.334.1496370242002; ULV=1496370242044:1:1:1:4728788087904.334.1496370242002:; SUB=_2A250NLxADeRhGeRI61AS9y3EwjuIHXVXQ6qIrDV8PUNbmtBeLRbHkW819Z5T7u6os2ZSd86EQTg4Ord27A..; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9WFf.R1vC52LB1wpRr0ZRnFx5JpX5KzhUgL.Fozcehz0S0eR1KM2dJLoIXnLxK-L1-zL1-zLxK-L12BL1h2LxK-LBozL1h2LxKML1-2L1hBLxKnL1h2L12eLxKBLBonL1-2LxK.L1h5L1h.LxKqL1h.L12zt; SUHB=0103Z6AXvYXZsu; ALF=1527906191; SSOLoginState=1496370192; wvr=6; YF-Page-G0=b98b45d9bba85e843a07e69c0880151a"} #将your cookie替换成自己的cookie
    
    def test():
        url = 'http://weibo.cn/2680638954/info'
        html = getHtml.getHtml(url,  headers = weibo.cookie)
        print(html)
...
user_id = 2680638954 #可以改成任意合法的用户id（爬虫的微博id除外）
